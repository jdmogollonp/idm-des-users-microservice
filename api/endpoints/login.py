...
from schemas.msg import Msg as SchemaMsg
from api import deps
...
@router.post("/password-recovery/{email}", response_model=SchemaMsg)
...
@router.post("/reset-password/", response_model=SchemaMsg)
def reset_password(
    token: str = Body(...) ,
